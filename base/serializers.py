...
class UsersSerializer(serializers.Serializer):
    ...
    usernames = serializers.ListField(
        ...
        max_length = 30,
        error_messages = {
            'not_a_list': _('Se esperaba una lista de items pero se obtuvo el tipo "{input_type}".'),
    ...
    def validate_usernames(self, usernames):
        ...
        if users_not_found:
            raise serializers.ValidationError(
                _("Los siguientes usuarios no se encontraron {users}".format(
    ...
    def create(self, validate_data):
        ...
        gap_finder = GapFinder(
            strings_shedules, 
            compute_sd = validate_data['compute_sd']
        )
